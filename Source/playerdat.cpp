...
/* HeroClass::Bomoh */     { N_("Bomoh"),      "monk",          15,      25,         15,        30,        45,    200,         85,        130,        10, (23 << 6),  static_cast<int>(5.5F * 64),  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64), SpellID::Confuse,       },
	// clang-format on
};
