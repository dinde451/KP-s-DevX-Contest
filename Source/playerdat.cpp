...
/* HeroClass::Mojomancer */     { N_("Mojomancer"),      "monk",          15,      25,         15,        30,        45,    200,         85,        130,        10, (23 << 6),  static_cast<int>(5.5F * 64),  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64), SpellID::Confuse,       },
	// clang-format on
};
...
/* HeroClass::Mojo */      {     112,    112,      130,   130,    98,      98,         114,    114,     114,     160 },
	// clang-format on
};
...
/* HeroClass::Mojo */      {           12,                  7,                  12,                        7,          16,               10,                16,                     12,        20,             14,        23,             14,         16,              12,               16,                    12,          13,                8,          8,              8,              3,          20,            18,              6,             20,                 8,                 13 },
	// clang-format on
};
